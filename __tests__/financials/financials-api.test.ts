...
describe("getRevenueSummary", () => {
  it("sums sent+paid only, splits by opco, outstanding = sent amount_due", async () => {
    s.invoices = [
      { opco: "integrated_solutions", status: "sent", total: 100, amount_due: 90, holdback_amount: 10, issue_date: "2026-07-01", tax_amount: 11.5 },
      { opco: "guardian", status: "paid", total: 200, amount_due: 200, holdback_amount: 0, issue_date: "2026-07-02", tax_amount: 23 },
      { opco: "integrated_solutions", status: "draft", total: 999, amount_due: 999, holdback_amount: 0, issue_date: null, tax_amount: 0 },
      { opco: "guardian", status: "void", total: 500, amount_due: 500, holdback_amount: 50, issue_date: "2026-07-03", tax_amount: 65 },
    ];
...
describe("getReceivablesByClient", () => {
  it("groups open ('sent') invoices by client with oldest issue date, sorted by balance", async () => {
    s.invoices = [
      { client_id: "c1", status: "sent", amount_due: 100, issue_date: "2026-05-01", client: { name: "Acme" } },
      { client_id: "c1", status: "sent", amount_due: 50, issue_date: "2026-07-01", client: { name: "Acme" } },
      { client_id: "c2", status: "sent", amount_due: 60, issue_date: "2026-06-15", client: { name: "Beta" } },
      { client_id: "c1", status: "paid", amount_due: 0, issue_date: "2026-04-01", client: { name: "Acme" } },
      { client_id: "c3", status: "draft", amount_due: 999, issue_date: null, client: { name: "Gamma" } },
    ];
