...
const TEMPLATES: Array<Omit<AuditEntry, "id" | "timestamp" | "userId" | "ipAddress">> = [
  ...
  { action: "Project · Edit Tasks", module: "Projects", target: "pr-001 — Meridian Capital Plaza", result: "Success" },
  ...
  { action: "Schedule · Reassign Job", module: "Scheduling", target: "Job-12 → Damola Okafor", result: "Success" },
  { action: "Schedule · Reassign Job", module: "Scheduling", target: "Job-19 → Naomi Khaled", result: "Denied" },
